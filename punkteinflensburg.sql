...
-- Fach: Datenbanken
-- Dozent: Herr Baar
-- Projekt Name: Punkte in Flensburg
-- Beschreibung: bitte Beschreibung von unserem Projekt schreiben
-- Gruppenmitglieder: Hidayat Halim (s0536950), Halil Aykut Ince (bitte deine Matrikelnummer hier eintragen)
-- --------------------------------------------------------------------------------------------------------------------
